            ...
            <Grid item xl={12} lg={12} md={12} sm={6}>
              ...
              <nav>
                <ul className={navLinks}>
                    ...
                    <li className={navLinkItem}><Button variant="text"><Link to="/acnh" className={navLinkText}>ACNH</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/arttips" className={navLinkText}>Art Tips</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/food" className={navLinkText}>Food Pics</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/funtweets" className={navLinkText}>Fun Tweets</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/crafts" className={navLinkText}>Crafts</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/codeinfo" className={navLinkText}>Coding</Link></Button></li>
                    ...
                    <li className={navLinkItem}><Button variant="text"><Link to="/games" className={navLinkText}>Games</Link></Button></li>
                    <li className={navLinkItem}><Button variant="text"><Link to="/marvel" className={navLinkText}>Marvel</Link></Button></li>
